...
# for k, v in edges:
#     edges_rev[v] = edges_rev.get(v,[]) + [k]

# # print(edges_rev)

# anc = []

# def parent_ret(node, l):
#     if len(edges_rev.get(node,[])) == 0:
#         return []
#     else:
#         par_list = edges_rev[node]
